public class Lab2InhritanceAndPolymorphism {
    public static void main(String[] args) {
        Video vid=new Video(456987, "RRR",20,1000, "Raj", "pop", 2022);
        System.out.println(vid.getNumberOfCopies());
        Book book = new Book(32165, "crime", 450, "Ankit Mishra");
        System.out.println(book.getAuthor());
        CD cd = new CD(20245, "cid",50, 540, "daya", "crime");
        System.out.println(cd.getNumberOfCopies());
